<template>
  <div class="card-row-wrapper">
    ...
    <div ref="cardRow" class="card-row">
      <NuxtLink class="card-container" to="/activityIntro">
        <img
...
const scrollAmount = 200 // Adjust as needed for card width
...
.card-container:hover {
  box-shadow: 0 5px 32px rgba(94, 94, 94, 0.5), 0 2px 8px rgba(54, 54, 54, 0.1);
