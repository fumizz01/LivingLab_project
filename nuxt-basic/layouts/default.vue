  ...
  <v-app>
      ...
      <v-app-bar color="black" dark app>
        <div style="display: flex; align-items: center">
          ...
          >
            <v-btn class="nav-btn" variant="text" to="/">หน้าแรก</v-btn>
        ...
        <v-menu class="d-sm-none" offset-y location="top end">
          ...
          <v-list style="width: 100%">
            ...
            <v-list-item to="/login">ลงชื่อเข้าใช้</v-list-item>
            <v-list-item>
              <v-btn-toggle
                class="lang-toggle"
                mandatory
        ...
        <v-btn text to="/login" class="d-none d-sm-flex">ลงชื่อเข้าใช้</v-btn>
        <v-btn-toggle
